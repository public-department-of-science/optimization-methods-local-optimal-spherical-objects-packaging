...
namespace hs071_cs
{
    ...
    public class Data : IComparable<Data>
    {
        ...
        public Data(double[] x, double[] y, double[] z, double[] r, double R, int ballCount, int holeCount,
            TaskClassification taskClassification, ObjectType[] type = null, double[] Weight = null, double[,] C = null) : this(ballCount)
        {
            this.R = R;
