...
namespace hs071_cs
{
    public static class Input
    {
        ...
        private static double[,] RandGenerateBondMatrix()
        {
            ...
            //OutPut.WriteLine("Сначала решаем однокритериальную задачу с \"нулевыми\" связями (задача равновесной упаковки) ");
            OutPut.WriteLine("Решаем двухкритериальную задачу");
