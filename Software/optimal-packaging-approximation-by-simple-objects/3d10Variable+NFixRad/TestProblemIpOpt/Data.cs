...
namespace hs071_cs
{
    public enum ObjectType
    {
        ...
        VariableRadiusBall = 4, // variable radius ball
    ...
    public class Data : IComparable<Data>
    {
        ...
        public Data(double[] x, double[] y, double[] z, double[] r, double R, int ballCount, int VariableBALLS, int holeCount, TaskClassification taskClassification, ObjectType[] type = null, double[] Weight = null, double[,] C = null) : this(ballCount)
        {
            this.R = R;
            this.ballCount = ballCount;
            this.holeCount = holeCount;
            VariableBALLSCount = VariableBALLS;
